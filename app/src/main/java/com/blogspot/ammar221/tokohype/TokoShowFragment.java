package com.blogspot.ammar221.tokohype;
...
public class TokoShowFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        url = "http://192.168.70.216/SMPIDN/webdatabase/tokohype.php";
        showData();
    ...
    private void showData() {
        ...
        progressDialog.setTitle("Loading HYPEBEAST");
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a++) {
                        ...
                        rowData.put("stock", jsonObject.getString("stock"));
